...
class LainyaIndex extends Component
{
    use WithPagination;
    ...
    {
        $lainya = Lainya::with(['employeeMaster','vendors'])
        ...
        return view('livewire.dashboard.lainya.lainya-index', $data)->layout('layouts.dashboard', [
            'header' => 'lainya'
        ]);
    }
    ...
    public function export()
    {
        ...
        $fileName = 'uang-lainya-employee-' . $date . '.xlsx'; // Append the date to the file name
