...
class StandIndex extends Component
{
    ...
    {
        $stand = Stand::with(['employeeMaster','vendors'])
        ...
        return view('livewire.dashboard.stand.stand-index', $data)->layout('layouts.dashboard', [
            'header' => 'Uang StandBy'
        ]);
    }
    ...
    public function export()
    {
        ...
        $fileName = 'uang-stand-employee-' . $date . '.xlsx'; // Append the date to the file name
