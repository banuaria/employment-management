...
class RetributionIndex extends Component
{
    use WithPagination;
    ...
    {
        $retribution = Retribution::with(['employeeMaster','vendors'])
        ...
        return view('livewire.dashboard.retribution.retribution-index', $data)->layout('layouts.dashboard', [
            'header' => 'Retribution'
        ]);
    }
    ...
    public function export()
    {
        ...
        $fileName = 'uang-retribution-employee-' . $date . '.xlsx'; // Append the date to the file name
