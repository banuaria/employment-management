...
class RetributionImport extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.dashboard.retribution.retribution-import');
    }
    ...
    public function store()
    {
        ...
        foreach ($this->employees as $employeeData) {
            ...
            $existingAbsence = Retribution::where([
            ...
            if ($data) {
                $this->dispatch('retribution-imported');
                $this->dispatch('close-modal', name: 'import-retribution-modal');
                $this->reset();
                $this->resetValidation();
                $this->dispatch('alert-success', title: 'Total Amount Retribution Successfully Imported!');
            } else {
