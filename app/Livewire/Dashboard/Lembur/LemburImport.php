...
class LemburImport extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.dashboard.lembur.lembur-import');
    }
    ...
    public function store()
    {
        ...
        foreach ($this->employees as $employeeData) {
            ...
            if ($data) {
                $this->dispatch('lembur-imported');
                $this->dispatch('close-modal', name: 'import-lembur-modal');
                $this->reset();
                $this->resetValidation();
                $this->dispatch('alert-success', title: 'Lembur Successfully Imported!');
            } else {
                $this->dispatch('alert-failure', title: 'Failed to Import Lembur');
            }
