...
class LemburIndex extends Component
{
    use WithPagination;
    ...
    {
        $lembur = Lembur::with(['employeeMaster','vendors'])
        ...
        return view('livewire.dashboard.lembur.lembur-index', $data)->layout('layouts.dashboard', [
            'header' => 'Lembur'
        ]);
    }
    ...
    public function export()
    {
        ...
        $fileName = 'lembur-employee-' . $date . '.xlsx'; // Append the date to the file name
