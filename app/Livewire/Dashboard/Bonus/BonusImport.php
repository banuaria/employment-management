...
class BonusImport extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.dashboard.bonus.bonus-import');
    }
    ...
    public function store()
    {
        ...
        foreach ($this->employees as $employeeData) {
            ...
            $existingAbsence = BonusBBM::where([
            ...
            if ($data) {
                $this->dispatch('bonus-imported');
                $this->dispatch('close-modal', name: 'import-bonus-modal');
                $this->reset();
                $this->resetValidation();
