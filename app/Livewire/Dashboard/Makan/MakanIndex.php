...
class MakanIndex extends Component
{
    use WithPagination;
    ...
    {
        $makan = Makan::with(['employeeMaster','vendors'])
        ...
        return view('livewire.dashboard.makan.makan-index', $data)->layout('layouts.dashboard', [
            'header' => 'Makan'
        ]);
    }
    ...
    public function export()
    {
        ...
        $fileName = 'uang-makan-employee-' . $date . '.xlsx'; // Append the date to the file name
