<div>
    <form wire:submit="store" class="px-0.5">
        <div>
            <x-input-label for="name-faq-category-edit" :value="__('Title')" />
            <x-text-input wire:model="title" id="name-faq-category-edit" class="block mt-1 w-full" type="text" name="title" />
