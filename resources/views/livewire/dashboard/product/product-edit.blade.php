                        ...
                        <div class="relative">
                            ...
                            <div class="flex-1">
                                <div class="w-full border border-primary-50 rounded-xl p-4">
                                    <div>
                                        <x-input-label for="title-product-edit" :value="__('Title')" required="true"/>
                                        <x-text-input wire:model="title" id="title-product-edit" class="block mt-1 w-full" type="text" name="title" required/>
                                        <x-input-error :messages="$errors->get('title')" class="mt-2" />
                                    </div>
                                    <div class="mt-4">
                                        <x-input-label class="mb-2" for="content-product-edit" :value="__('Description')" required="true"/>
                                        <div wire:ignore>
                                            <x-textarea-input wire:model.change="content" id="content-product-edit" class="block mt-1 w-full tinymce-textarea" tinymce-textarea-id="1" type="text" name="content" rows="3" required></x-textarea-input>
                                        </div>
                                        <x-input-error :messages="$errors->get('content')" class="mt-2" />
                                    </div>
                                    <div class="mt-4">
                                        <x-input-label class="mb-2" for="usage-product-edit" :value="__('How To Use')" required="true"/>
                                        <div wire:ignore>
                                            <x-textarea-input wire:model.change="usage" id="usage-product-edit" class="block mt-1 w-full tinymce-textarea" tinymce-textarea-id="2" type="text" name="usage" rows="3" required></x-textarea-input>
                                        </div>
                                        <x-input-error :messages="$errors->get('usage')" class="mt-2" />
                                    </div>
                                    <div class="mt-4">
                                        <x-input-label for="meta-title-product-edit" :value="__('Meta Title')" />
                                        <x-text-input wire:model="meta_title" id="meta-title-product-edit" class="block mt-1 w-full" type="text" name="meta_title" />
                                        <x-input-error :messages="$errors->get('meta_title')" class="mt-2" />
                                    </div>
                                    <div class="mt-4">
                                        <x-input-label for="meta-desc-product-edit" :value="__('Meta Description')" />
                                        <x-textarea-input wire:model="meta_desc" id="meta-desc-product-edit" class="block mt-1 w-full" type="text" name="meta_desc" rows="3"></x-textarea-input>
                                        <x-input-error :messages="$errors->get('meta_desc')" class="mt-2" />
                                    </div>
                                    <div class="mt-4">
                                        <x-input-label for="meta-keywords-product-edit" :value="__('Meta Keywords')" />
                                        <x-text-input wire:model="meta_keywords" id="meta-keywords-product-edit" class="block mt-1 w-full" type="text" name="meta_keywords" />
                ...
                <div class="w-full xl:w-2/6 flex flex-col-reverse xl:flex-col gap-y-4">
                        ...
                        <div class="relative">
                            ...
                            <div class="flex space-x-4">
                                ...
                                <a href="{{ route('cms.product.index') }}">
                                    <div class="inline-flex items-center px-4 py-2 bg-white hover:bg-gray-100 active:bg-gray-200 border border-indigo-600 rounded-md font-semibold text-xs text-indigo-600 uppercase tracking-widest transition ease-in-out duration-1500">
                                        {{ __('Cancel') }}
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="px-0.5">
                                <div>
                                    ...
                                    <x-input-label for="thumbnail-product-edit" :value="__('Thumbnail')" required="true"/>
                                    <div class="my-1 px-11 py-4 relative flex justify-center border border-gray-200 rounded-md shadow-sm">
                                        @if (!$thumbnail)
                                        <x-icon-image wire:click="$dispatch('filemanager-picker', { to: 'dashboard.product.product-edit', filetype: 'image', property: 'thumbnail' })" class="absolute top-1 left-2 w-7 h-7 text-gray-300 cursor-pointer"></x-icon-image>
                                        @endif
                                ...
                                <div class="mt-4">
                                    <div class="flex flex-row space-x-2 items-center">
                                        <x-input-label for="product-photo-paths-product-edit" :value="__('Photos')" />
                                        <div class="text-xs">(Quota: {{ $product_photo_max - count($product_photo_paths) }})</div>
                                    </div>
                                    <div class="my-1 px-11 py-4 relative flex justify-center border border-gray-200 rounded-md shadow-sm">
                                        @if (count($product_photo_paths) < $product_photo_max)
                                        <x-icon-image wire:click="$dispatch('filemanager-picker', { to: 'dashboard.product.product-edit', filetype: 'image', property: 'product_photo_paths' })" class="absolute top-1 left-2 w-7 h-7 text-gray-300 cursor-pointer"></x-icon-image>
                                        @endif
                    ...
                    <div class="p-4 sm:p-8 bg-white shadow rounded-lg w-full">
                        <div class="relative">
                            ...
                            <div class="px-0.5">
                                <div>
                                    <x-input-label for="product-category-id-product-edit" :value="__('Category')" required="true"/>
                                    <select wire:model.change="product_category_id" id="product-category-id-product-edit" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <div class="mt-4">
                                    <x-input-label for="product-subcategory-id-product-edit" :value="__('Subcategory')" required="true"/>
                                    <select wire:model="product_subcategory_id" id="product-subcategory-id-product-edit" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <div class="mt-4">
                                    <x-input-label for="product-tag-ids-product-edit" :value="__('Tags')" />
                    ...
                    <div class="p-4 sm:p-8 bg-white shadow rounded-lg w-full">
                        <div class="relative">
                            ...
                            <div class="px-0.5">
                                <div>
                                    <x-input-label for="product-stores-product-edit" :value="__('Stores')" />  
