<div>
    <form wire:submit="store" class="px-0.5">
        <!-- Name -->
        <div>
            <x-input-label for="name-vendor-create" :value="__('Name')" />
            <x-text-input wire:model="name" id="name-vendor-create" class="block mt-1 w-full" type="text" name="name" autofocus autocomplete="name" />
