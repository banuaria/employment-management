<div class="py-12">
    ...
    <x-modal name="import-bpjs-modal" closable="false" maxWidth="lg">
        <div class="flex justify-between items-start mb-4 space-x-4">
            <h4 class="font-semibold text-gray-600 pt-1 uppercase">
                Import Bpjs
            </h4>
            <button
                wire:click="$dispatch('close-modal', { name: 'import-bpjs-modal' })"
                type="button"
        ...
        <div class="flex-1 overflow-auto x-modal-content">
            <livewire:dashboard.bpjs.bpjs-import @bpjsImported="$refresh" />
        </div>
    </x-modal>

    <x-modal name="edit-bpjs-modal" closable="false" maxWidth="lg">
        <div class="flex justify-between items-start mb-4 space-x-4">
            <h4 class="font-semibold text-gray-600 pt-1 uppercase">
                Edit BPJS  
            </h4>
            <button
                wire:click="$dispatch('close-modal', { name: 'edit-bpjs-modal' })"
                type="button"
                class="text-gray-600 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 p-2 rounded-full inline-flex items-center"
            >
                <x-icon-close class="w-4 h-4"></x-icon-close>
        ...
        <div class="flex-1 overflow-auto x-modal-content">
            <livewire:dashboard.bpjs.bpjs-edit @bpjsEdited="$refresh" />
        </div>
    </x-modal>
</div>
