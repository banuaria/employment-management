<div>
    <form wire:submit="store" class="px-0.5">
        <div>
            <x-input-label class="mb-2" for="content-about-edit-content" :value="__('Content')" />
            <div wire:ignore>
                <x-textarea-input wire:model.change="content" id="content-about-edit-content" class="block mt-1 w-full tinymce-textarea" tinymce-textarea-id="1" type="text" name="content" rows="3"></x-textarea-input>
            </div>
