<div>
    <form wire:submit="store" class="px-0.5">
        <div>
            <x-input-label for="post-category-id-post-subcategory-create" :value="__('Category')" />
            <select wire:model="post_category_id" id="post-category-id-post-subcategory-create" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
        ...
        <div class="mt-4">
            <x-input-label for="name-post-subcategory-create" :value="__('Title')" />
            <x-text-input wire:model="title" id="name-post-subcategory-create" class="block mt-1 w-full" type="text" name="title" />
