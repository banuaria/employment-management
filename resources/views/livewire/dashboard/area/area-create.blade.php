<div>
    <form wire:submit="store" class="px-0.5">
        ...
        <div class="mt-4">
         ...
         <!-- UMK  -->
         <div class="mt-4">
            <x-input-label for="umkharian-user-create" :value="__('Total Harian UMK')" />
            <x-text-input wire:model="total_harian" id="umkharian-user-create" class="block mt-1 w-full" type="number" name="umk" autocomplete="umkharian" />
